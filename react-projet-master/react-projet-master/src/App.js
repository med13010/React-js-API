...
class App extends Component {
            ...
            <div className="App">
                ...
                <nav>
                    <div class="nav-wrapper">
                        <a href="#" class="brand-logo">TP - 8 : Deschamps Meddy</a>
                        <ul id="nav-mobile" class="right hide-on-med-and-down">
                            <li><a href="http://edition.cnn.com/">CNN</a></li>
                            <li><a href="http://www.bbc.com/news">BBC</a></li>
                            <li><a href="http://www.bfmtv.com/">BFMTV</a></li>
                        </ul>
                    </div>
                </nav>

                <div class="input-field">
                    <input placeholder="Key Word" type="text" onChange={ this.filter } >
                    </input>
                </div>
                <div className="App-content">
                    <div className="center-align">
                        ...
                        <form onSubmit={ this.fetchTitles } style={ { marginTop: -32, marginLeft: 140 } } >
                            <button type="submit" style={ { marginLeft: 140, marginTop: -4 } } className="waves-effect waves-light btn">
                                Titles
                        </button>
                        </form>
                    </div>

                    <div className="row" style={ { marginTop: 20, marginLeft: -400 } } >
    ...
    fetchTitles = async ( event ) => {
        ...
        try {
            ...
            let _titles = await get( ENDPOINTS.NEWS_API_URL, {
                //YOU NEED TO PROVIDE YOUR "APIXU" API KEY HERE, see /utils/api.js file to grab the DOCUMENTATION file
                apiKey: NEWS_API_KEY,
                source: 'techcrunch'
            })
    ...
    displayNews = () => {
        ...
        if ( titles ) {
            ...
            const _title = titles.articles[ 0 ].title

            return titles.articles.map(
                article =>
                    <NewsCard
